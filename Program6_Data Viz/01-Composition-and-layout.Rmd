...
We may be interested in working from here on only with data for proteins CP and SERPINA3.
```{r}
CRC.twopro <- CRC[,c('CP', 'SERPINA3')]
```
---
...
> **Challenge**
> If you want to explore the relationship between the abundance of protein AFM and AHSG and see the difference between male and female, what plot will you make?
Save your plot!
...
```{r}
ggplot(data = CRC) +
  geom_point(mapping = aes(x = AFM, y = AHSG,color = Gender))
