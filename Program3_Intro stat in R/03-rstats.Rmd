...
# Part 5b: Analysis of categorical data
...
`table` function generates contingency table of the counts at each combination.
...
`table` function also can calculate 2-way contingency table. Let's get the table and visualise the count data.
